      ...
      <div className='space-y-1 w-full'>
        ...
        <Button variant={favorites? 'secondary':'ghost'} asChild size='lg' className='font-normal justify-start px-2 w-full'>
          <Link href={{
            ...
            {/* This adds a query parameter to the URL. When this link is clicked, the URL will become something like http://example.com/?favorites=true */}
